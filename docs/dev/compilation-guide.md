# 编译指南 <Badge type="danger" text="过时" />

::: danger
该教程已经过时，2026年2月7日，BILIBILIAS在QQ频道发布通知，为大家提供了最后一个预发布版本的编译指南。目前该项目恢复代码提交，但不会发布APK，跟随主仓库的调整，目前该指南已经过期，新的指南暂未编写，后来者需要自行拉取代码编译，或修改仓库目前最新的工作流进行托管编译。
:::
